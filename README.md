<div align="center">
  <img alt="Logo" src="https://github.com/EndCar808/personal_website/blob/main/src/images/logo.png" width="100" />
</div>
<h1 align="center">
  Personal Website - 
</h1>
...
![demo](https://github.com/EndCar808/personal_website/blob/main/src/images/demo.png)

## 🛠 Installation & Set Up

1. Install the Gatsby CLI (I recomend using version 3.4.1 as this is compatible with all the dependencies in package.json)

   ```sh
   npm install -g gatsby-cli^3.4.1
   ```
