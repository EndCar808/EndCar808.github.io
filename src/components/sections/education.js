...
const Education = () => {
  ...
  const educationData = datawork.education.edges;
        ...
        <StyledTabList role="tablist" aria-label="Job tabs" onKeyDown={e => onKeyDown(e)}>
          {educationData &&
            educationData.map(({ node }, i) => {
              const { location } = node.frontmatter;
              return (
                <StyledTabButton
                  key={i}
        ...
        <StyledTabPanels>
          {educationData &&
            educationData.map(({ node }, i) => {
              ...
              const { degree, url, course, range, award, thesis } = frontmatter;
              ...
              return (
                <CSSTransition key={i} in={activeTabId === i} timeout={250} classNames="fade">
                  <StyledTabPanel
                    ...
                    <p className="thesis">Thesis&nbsp;:&nbsp; {thesis}</p>
